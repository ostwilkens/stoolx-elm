...
var $author$project$Connection$Connection = F2(
...
var $author$project$Connection$inputDecoder = A3(
...
var $author$project$Connection$outputDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'index',
	$elm$json$Json$Decode$int,
	A3(
...
var $author$project$Connection$decoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'output',
	$author$project$Connection$outputDecoder,
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'input',
		$author$project$Connection$inputDecoder,
...
var $author$project$Vec2$decoder = A3(
	...
	A3(
		...
		'x',
		$elm$json$Json$Decode$float,
		$elm$json$Json$Decode$succeed($author$project$Vec2$Vec2)));
...
var $author$project$Model$modelDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'connections',
	$elm$json$Json$Decode$list($author$project$Connection$decoder),
	A3(
		$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'nodes',
		$elm$json$Json$Decode$list($author$project$Node$decoder),
		$elm$json$Json$Decode$succeed($author$project$Model$SavedModel)));
var $author$project$Model$decodeStoredModel = function (modelJson) {
	var _v0 = A2($elm$json$Json$Decode$decodeValue, $author$project$Model$modelDecoder, modelJson);
	if (_v0.$ === 'Ok') {
...
var $author$project$Main$init = function (flags) {
	var savedModel = function () {
		if (flags.$ === 'Just') {
			...
			return $author$project$Model$decodeStoredModel(modelJson);
		} else {
			return {connections: _List_Nil, nodes: _List_Nil};
		}
	}();
...
var $author$project$Model$ResizeWindow = function (a) {
	return {$: 'ResizeWindow', a: a};
};
var $author$project$Model$UpdateTime = function (a) {
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$elm$browser$Browser$Events$onAnimationFrameDelta($author$project$Model$UpdateTime),
...
var $author$project$Model$connecting = function (model) {
...
var $author$project$Connection$removePreviousConnection = F2(
	function (connections, newConnection) {
		return A2(
			$elm$core$List$filter,
			function (c) {
				return !_Utils_eq(c.input, newConnection.input);
			},
			connections);
	});
...
var $author$project$Connection$connectionHasAnyNode = F2(
	function (nodes, connection) {
		return A2(
			$elm$core$List$any,
			$author$project$Connection$connectionHasNode(connection),
			nodes);
	});
var $author$project$Connection$connectionHasNoNode = F2(
	function (nodes, connection) {
		return !A2($author$project$Connection$connectionHasAnyNode, nodes, connection);
	});
var $author$project$Model$removeSelected = function (model) {
	...
	var connections = A2(
		$elm$core$List$filter,
		$author$project$Connection$connectionHasNoNode(nodesToRemove),
		model.connections);
	return _Utils_update(
		model,
...
var $author$project$Vec2$encode = function (vec2) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'x',
				$elm$json$Json$Encode$float(vec2.x)),
				_Utils_Tuple2(
				'y',
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'nodes',
				A2($elm$json$Json$Encode$list, $author$project$Node$encode, model.nodes)),
				_Utils_Tuple2(
				'connections',
				A2($elm$json$Json$Encode$list, $author$project$Connection$encode, model.connections))
			]));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Remove':
				return _Utils_Tuple2(
					$author$project$Model$removeSelected(model),
					$elm$core$Platform$Cmd$none);
			case 'Save':
				return _Utils_Tuple2(
					model,
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A4($avh4$elm_color$Color$rgba, 0, 1, 0, 0.7)),
...
var $author$project$Main$clientPos = function (event) {
	...
	var x = _v0.a;
	var y = _v0.b;
	return A2($author$project$Vec2$Vec2, x, y);
};
var $author$project$Model$SetCode = function (a) {
	return {$: 'SetCode', a: a};
};
...
var $author$project$Node$getSelectedCode = function (nodes) {
	var selectedNodes = A2(
		...
		nodes);
	var _v0 = $elm$core$List$head(selectedNodes);
	if (_v0.$ === 'Just') {
		var node = _v0.a;
		return node.code;
	} else {
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Model$Add = {$: 'Add'};
...
var $author$project$Elements$addButton = A2(
		...
		]),
	{
		...
		onPress: $elm$core$Maybe$Just($author$project$Model$Add)
	});
...
var $author$project$Elements$removeButton = A2(
		...
		]),
	{
		...
		onPress: $elm$core$Maybe$Just($author$project$Model$Remove)
	});
...
var $author$project$Model$StartConnect = function (a) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Model$StartConnect(socket)),
				$mdgriffith$elm_ui$Element$Events$onMouseUp(
				$author$project$Model$Connect(socket))
			]),
		$mdgriffith$elm_ui$Element$none);
};
...
var $author$project$Elements$nodeEl = F2(
	function (center, node) {
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$moveRight((node.pos.x + center.x) - ($author$project$Node$width / 2)),
					$mdgriffith$elm_ui$Element$moveDown((node.pos.y + center.y) - ($author$project$Node$height / 2))
				]),
			A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$height(
						$mdgriffith$elm_ui$Element$px($author$project$Node$height)),
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								$mdgriffith$elm_ui$Element$behindContent(
								$author$project$Elements$shaderEl(model)),
